...
def minimax(board, color, depth, castling_rights, alpha=-999999, beta=999999):
    if depth == 0:
    ...
    for move in get_allmoves(board, color, castling_rights):
        ...
        score = minimax(board, "black" if color == "white" else "white", depth-1, castling_rights, alpha, beta)
